...
import (
	...
	healthModule "github.com/ericmarcelinotju/congregator/module/health"
	userModule "github.com/ericmarcelinotju/congregator/module/user"
	"github.com/ericmarcelinotju/congregator/plugins/job"

	"github.com/ericmarcelinotju/congregator/router/middleware"
	swaggerRoutes "github.com/ericmarcelinotju/congregator/router/swagger"

	"github.com/ericmarcelinotju/congregator/utils/response"
)
