...
import (
	...
	"github.com/ericmarcelinotju/congregator/constant/enums"
...
func NewJobProcessor() func(ctx context.Context, job dto.JobDto) error {
	return func(ctx context.Context, currJob dto.JobDto) error {
		// Process job
